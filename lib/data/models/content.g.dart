...
_BrandingConfig _$BrandingConfigFromJson(Map<String, dynamic> json) =>
    _BrandingConfig(
      ...
      secondaryColor: json['secondaryColor'] as String? ?? '#141414',
      accentColor: json['accentColor'] as String? ?? '#F5C518',
      backgroundColor: json['backgroundColor'] as String? ?? '#000000',
      surfaceColor: json['surfaceColor'] as String? ?? '#1A1A1A',
      textPrimaryColor: json['textPrimaryColor'] as String? ?? '#FFFFFF',
      textSecondaryColor: json['textSecondaryColor'] as String? ?? '#B3B3B3',
...
Map<String, dynamic> _$BrandingConfigToJson(_BrandingConfig instance) =>
    <String, dynamic>{
      ...
      'appTagline': instance.appTagline,
...
_VideoAsset _$VideoAssetFromJson(Map<String, dynamic> json) => _VideoAsset(
      ...
      vimeoVideoId: json['vimeoVideoId'] as String?,
      qualities: (json['qualities'] as List<dynamic>?)
          ?.map((e) => VideoQuality.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$VideoAssetToJson(_VideoAsset instance) =>
    <String, dynamic>{
      'id': instance.id,
      'playerType': instance.playerType,
      'status': instance.status,
      'hlsManifestUrl': instance.hlsManifestUrl,
      'youTubeVideoId': instance.youTubeVideoId,
      'vimeoVideoId': instance.vimeoVideoId,
...
_LiveStream _$LiveStreamFromJson(Map<String, dynamic> json) => _LiveStream(
      ...
      dvrEnabled: json['dvrEnabled'] as bool?,
    );
...
Map<String, dynamic> _$LiveStreamToJson(_LiveStream instance) =>
    <String, dynamic>{
      ...
      'dvrEnabled': instance.dvrEnabled,
    };
...
_SubscriptionPlan _$SubscriptionPlanFromJson(Map<String, dynamic> json) =>
    _SubscriptionPlan(
      ...
      maxQuality: json['maxQuality'] as String?,
...
Map<String, dynamic> _$ContentRowToJson(_ContentRow instance) =>
    <String, dynamic>{
      'id': instance.id,
      'title': instance.title,
...
_WatchParty _$WatchPartyFromJson(Map<String, dynamic> json) => _WatchParty(
      ...
      members: (json['members'] as List<dynamic>?)
          ?.map((e) => WatchPartyMember.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$WatchPartyToJson(_WatchParty instance) =>
    <String, dynamic>{
      'code': instance.code,
      'contentId': instance.contentId,
      'status': instance.status,
...
Map<String, dynamic> _$WatchPartyMemberToJson(_WatchPartyMember instance) =>
    <String, dynamic>{
